                ...
                methods: {
                    ...
                    placeOrder: function () {
                        ...
                        if (this.isPlaceOrderEnabled) {
                            ...
                            */
                            this.$root.showLoader();
                            //pass card info along with token to save-order route 'cardinfo':this.selected_card,
                            //this.$http.post("{{ route('shop.checkout.save-order') }}", [{'_token': "{{ csrf_token() }}",$paymentMethod, $cardinfo}])
                            this.$http.post("{{ route('shop.checkout.save-order') }}", {'payment': this.selected_payment_method,'_token': "{{ csrf_token() }}"})
                            .then(response => {
                                if (response.data.success) {

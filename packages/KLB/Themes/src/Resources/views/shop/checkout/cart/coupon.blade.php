...
<!--:disabled="disable_button"-->
                    <button class="theme-btn light" >{{ __('shop::app.checkout.onepage.apply-coupon') }}</button>
                </form>
            </div>

            <div class="applied-coupon-details" v-if="applied_coupon">
                <label>{{ __('shop::app.checkout.total.coupon-applied') }}</label>
                <label>@{{ coupon_description }}</label>
                ...
                applyCoupon: function() {
                    ...
                    axios.post(
                        ...
                        if (response.data.success) {
                            ...
                            this.coupon_code = '';
                            //save coupon description to coupon vue
                            this.coupon_description = response.data.description;

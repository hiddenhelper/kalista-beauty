                                ...
                                @foreach ($customAttributes as $attribute)
                                    ...
                                    @if (view()->exists($typeView = 'admin::catalog.products.field-types.' . $attribute->type))
                                        ...
                                        <div class="control-group {{ $attribute->type }}"
                                            ...
                                            @php
                                                $visibleIndividually = $attribute->code == 'visible_individually';
                                                $guestCheckout = $attribute->code == 'guest_checkout';
                                                if ($visibleIndividually) {
                                                    $title = 'Should this product be visible by itself?';
                                                } elseif ($guestCheckout) {
                                                    $title = 'Should non-logged-in people be able to purchase this product?';
                                                } else {
                                                    $title = '';
                                                }
                                            @endphp

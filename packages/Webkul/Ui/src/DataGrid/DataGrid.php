...
abstract class DataGrid
{
    ...
    public function getCollection()
    {
        ...
        // $sku = $this->collection[0]->sku;
        // //$this->collection[0]->product_id = url('<a href="/admin/catalog/products/edit/1997" class="link">'.$url."</a>");
        // $url = url('/admin/catalog/products/edit/1997');
        // $this->collection[0]->product_id = $url;
    ...
    //render function that deals with abandoned cart
    public function renderWithId($id)
    {
        $this->addColumns();
        ...
        $this->prepareQueryBuilderWithParam($id);

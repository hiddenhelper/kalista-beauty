...
class InvoiceRepository extends Repository
{
    ...
    //get transaction id from invoice repo
    public function getTransId($orderid){
        return $this->model->where('order_id',$orderid)->first()['transaction_id'];
    }
    /**
     * @param  array  $data

        ...
        switch ($slug) {
            ...
            case 'clearance':
                ...
                if ($slug == "new-products") {
                    ...
                    $products = $this->velocityProductRepository->getBestProducts($count);
                } else if ($slug == "trending-now"){
                    $products = $this->velocityProductRepository->getTrendingProducts($count);
                } else if ($slug == "clearance"){
                    $products = $this->velocityProductRepository->getClearanceProducts($count);

...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
   ...
   // Route::get('/aboutAuthor', function () {
     //   return view(shop::Author.aboutAuthor);
    //})->name("shop.aboutAuthor");

    Route::get('/aboutauthors', 'Webkul\Shop\Http\Controllers\AuthorController@index')->defaults('_config', [
        'view' => 'shop::author.aboutauthors'
    ])->name('shop.author.aboutauthors');
...
// this is for brand
    ...
    Route::get('/brands/{parentbrand}/{brandname}', 'Webkul\Shop\Http\Controllers\BrandController@getBrand')->defaults('_config', [
        'view' => 'shop::products.index'
    ]);

//    /brands/brands-t-v/the-ordinary

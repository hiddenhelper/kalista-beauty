...
@push('scripts')
    <script type="text/x-template" id="best-sellers-template">
        <div class="new-products container-fluid">
            ...
            <template v-else-if="newProducts.length > 0">
                ...
                {!! view_render_event('bagisto.shop.best-sellers.before') !!}
                    ...
                    <div class="row justify-center">
                        <button class="homestyle-btn">SHOP BEST SELLERS</button>
                    </div>
                {!! view_render_event('bagisto.shop.best-sellers.after') !!}
            ...
            Vue.component('best-sellers', {
                ...
                methods: {
                    ...
                    'getNewProducts': function () {
                        this.$http.get(`${this.baseUrl}/category-details?category-slug=best-sellers&count={{ $count }}`)
                        .then(response => {
                             var count = '{{$count}}';

<div class="table">
    ...
    @push('scripts')
                    ...
                    <div class="filter-left">
                        <div class="search-filter">
                            <el-autocomplete
                                ...
                                @select="handleSelect"
                                @change="searchCollection(searchValue)"
                                style="float:left;"
                                v-if="pageCanAutocomplete">
                            </el-autocomplete>
                            ...
                            <div class="icon-wrapper">
                                <span class="icon search-icon search-btn"
                                      :style="pageCanAutocomplete ? 'float: left' : ''"
        ...
        <script v-if="pageCanAutocomplete" src="https://unpkg.com/element-ui/lib/index.js"></script>
        ...
        <script>
            Vue.component('datagrid-filters', {
                    ...
                    return {
                        ...
                        autoCompletePages: {
                            '/admin/promotions/cart-rules': {
                                'model': '\\Webkul\\CartRule\\Models\\CartRule',
                                'searchBy': 'name',
                            },
                ...
                mounted: function () {
                    ...
                    if (this.pageCanAutocomplete) {
                        this.includeElementStyling();
                        this.loadAllOptions();
                    }
                },

                computed: {
                    pageCanAutocomplete: function () {
                        return this.currentPage in this.autoCompletePages;
                    },
                },
                ...
                methods: {
                    handleSelect(item) {
                        ...
                        this.searchCollection(item.value);
                    },
                    loadAllOptions() {
                        let autoCompleteConfig = this.autoCompletePages[this.currentPage];

                        window.axios.get('/admin/klb/autocomplete', {
                            params: {
                                'model': autoCompleteConfig['model'],
                                'searchBy': autoCompleteConfig['searchBy'],
                            }
                        }).then((response) => {
                            this.options = response.data.map((option) => {
                                return {
                                    "name": option,
                                    "value": option, // Appears in autocomplete
                                };
                            });
                        });
                    },
                    ...
                    includeElementStyling: function () {

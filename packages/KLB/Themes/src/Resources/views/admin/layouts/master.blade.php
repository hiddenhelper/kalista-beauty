    ...
    <body @if (core()->getCurrentLocale() && core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
        ...
        <script type="text/javascript">
            window.addEventListener('DOMContentLoaded', function() {
                ...
                var listLastElement = $('.menubar li:last-child').offset();

                if (listLastElement) {
                    // TODO: This variable is declared but never used
                    var lastElementOfNavBar = listLastElement.top;
                }

                var navbarTop = $('.navbar-left').css("top");
                var menuTopValue = $('.navbar-left').css('top');

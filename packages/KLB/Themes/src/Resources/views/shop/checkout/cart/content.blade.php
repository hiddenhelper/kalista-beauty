    ...
    <script type="text/x-template" id="cart-template">
        <div class="container">
            <section class="cart-details row no-margin">
                        ...
                        <div class="cart-content col-12">
                            <form
                                ...
                                <div class="cart-item-list">
                                    ...
                                    @foreach ($cart->items as $key => $item)
                                        ...
                                        <div class="row col-12" v-if="!isMobileDevice">
                                            ...
                                            <!-- product name, price, move to wishlist, remove from cart -->
                                            <div class="product-details-content col-7 pr0">
                                                <div class="row item-title no-margin">
                                                    <a
                                                        ...
                                                        <!-- the product name as a link -->
                                                        <span class="fw6 link-color">{{ $product->name }}</span>
                                                    </a>
                                                </div>
                                ...
                                {!! view_render_event('bagisto.shop.checkout.cart.controls.after', ['cart' => $cart]) !!}
                                    ...
                                    {{-- Show link to shopping cart until viewing the shopping cart.
                                        Then, show continue shopping. --}}
                                    @if(Request::is('checkout/cart*'))
                                    <a
                                    title="{{ __('shop::app.checkout.cart.continue-shopping') }}"
                ...
                @if ($cart)
                <div class="you-may-also-like col-12">
                    @include('shop::checkout.section.youmayalsolike')
                </div>
                @endif

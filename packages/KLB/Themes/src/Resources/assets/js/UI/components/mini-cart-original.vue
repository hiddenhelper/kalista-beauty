...
<template>
    <div :class="`dropdown ${cartItems.length > 0 ? '' : 'disable-active'}`">
        ...
        <div
            ...
            <!--Body-->
            <!-- /checkout/cart copy in mini-cart container -->
            <div class="mini-cart-container">
                <!-- the "Shopping Cart" text at the top -->
                <h1 class="fw6 col-12">{{ miniCartTitleText }}</h1>

                <!-- the left side of the cart -->
                <div class="cart-details-header col-lg-6 col-md-12">
                    <!-- column headers: items, qty, subtotal -->
                    <span class="col-8 fw6 fs16 pr0">{{ itemsTitleText }}</span>
                ...
                </div> <!-- /.cart-details-header -->

                <div class="cart-details-header col-lg-6 col-md-12">
                    <p>right side</p>
                </div> <!-- /.cart-details-header -->
            </div> <!-- end of new mini-cart-container -->
